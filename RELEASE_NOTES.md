...
- Groq as a configurable AI provider option.
- Updated app icon assets.
- Corrected project save/open behavior and Keychain service naming.
- An MIT License.

Voice preview is no longer advertised in the current release documentation. Production-marker behavior remains an area to verify when typography or editor layout changes.
